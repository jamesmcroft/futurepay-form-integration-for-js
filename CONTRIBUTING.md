...
These guidelines are designed to help you as a contributor to bring your code and skills to the FuturePay Form Integration for JavaScript project to make it better.

## What can I contribute to?

Our [issue tracker](https://github.com/jamesmcroft/futurepay-form-integration-for-js/issues) contains a collection of features and issues waiting to be worked on! If you see any item marked with **Help Wanted**, we'd like to see you put your skills to use and contribute whatever you can to help develop the feature.
